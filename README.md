EE Attendee Mover Add-on
=========

[![Latest Release](https://img.shields.io/github/tag/eventespresso/eea-attendee-mover.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/eea-attendee-mover/releases)
[![Travis](https://travis-ci.org/eventespresso/eea-attendee-mover.svg?branch=master)](https://travis-ci.org/eventespresso/eea-attendee-mover)
...
[![Minimum EE Core Version:](https://img.shields.io/badge/Minimum%20EE%20core%20ver-4.9.13.p-red.svg)](https://github.com/eventespresso/event-espresso-core/releases/tag/4.9.13.p)
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/eea-attendee-mover?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license). 
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/ee4-attendee-mover?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
